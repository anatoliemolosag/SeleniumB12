...
public class AbsoluteXpath {
    ...
    public static void main(String[] args) {
        ...
        WebElement pharagraph = driver.findElement(By.xpath("/html/body/div[2]/div/div/p"));
        System.out.println(pharagraph.getText().trim());

        WebElement text2 = driver.findElement(By.xpath("//a[contains(text(),'Elemental Selenium')]"));
